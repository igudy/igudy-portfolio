...
export const products: Product[] = [
  {
    ...
    desc: "A modern core-banking platform for banks and fintechs, built as a large-scale micro-frontend web application by a big engineering team. I contributed to the frontend, including the User & Access Module, covering maker/checker approvals, permission-based access, and transaction limits, that powers secure day-to-day banking operations.",
